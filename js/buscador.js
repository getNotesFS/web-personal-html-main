...
function cargarContenido() {
    const paginas = ['index.html', 'musica.html', 'peliculas.html', 'sobre-mi.html', 'index.html', 'hobbies/index.html', 'hobbies/fotografia.html', 'hobbies/videojuegos.html', 'hobbies/senderismo.html'];
    paginas.forEach(url => {
...
function buscar(query) {
    ...
    const paginas = ['index.html', 'musica.html', 'sobre-mi.html', 'peliculas.html', 'index.html', 'hobbies/index.html', 'hobbies/fotografia.html', 'hobbies/videojuegos.html', 'hobbies/senderismo.html'];
